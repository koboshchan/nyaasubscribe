...
const HELP_TEXT = [
  ...
  "/help - this message",
  "",
  "How it works: add a subscription with the exact release title (for example Mushoku Tensei S3), pick a provider (SubsPlease, Erai-raws, Tsundere-Raws, AnoZu, or ToonsHub) and a resolution (480p, 720p, or 1080p). The bot polls nyaa.si in the background and automatically sends new matching episodes to your configured downloader.",
  "",
  "AnoZu and ToonsHub titles often carry both an English name and the original name (for example \"Love Unseen Beneath the Clear Night Sky 2026\" and \"Toumei na Yoru ni Kakeru Kimi to, Me ni Mienai Koi wo Shita\") - either one works as the subscription name. Note they upload anonymously (no verified account), so matching relies on their title tags rather than an uploader account.",
  "",
